...
@Autonomous(name = "StatesCloseBlue")
public class StatesCloseBlue extends OpMode {
    ...
    private final Pose firstIntakePose = new Pose(96, 84, Math.toRadians(0));
    private final Pose finalIntakePose = new Pose(128.5, 84,Math.toRadians(0));
