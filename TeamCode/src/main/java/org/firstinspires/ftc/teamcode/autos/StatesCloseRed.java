...
@Autonomous(name = "StatesCloseRed")
public class StatesCloseRed extends OpMode {
    ...
    private final Pose shootPose = new Pose(48,104, Math.toRadians(142));
    private final Pose firstIntakePose = new Pose(48, 84, Math.toRadians(180));
