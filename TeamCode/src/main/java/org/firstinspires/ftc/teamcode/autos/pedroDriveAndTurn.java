...
public class pedroDriveAndTurn extends OpMode {
    ...
    private final Pose startPose = new Pose(56,142,Math.toRadians(270));
    private final Pose shootPose = new Pose(56,100, Math.toRadians(270));
    private final Pose firstIntakePose = new Pose(40, 100, Math.toRadians(180));
